...
CREATE TABLE IF NOT EXISTS `db_college`.`department` (
  ...
  `SCHOOL_CODE` VARCHAR(8) NULL DEFAULT NULL,
...
-- -----------------------------------------------------
-- Table `db_college`.`enroll`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_college`.`enroll` (
  `CLASS_CODE` VARCHAR(5) NULL DEFAULT NULL,
  `STU_NUM` INT NULL DEFAULT NULL,
  `ENROLL_GRADE` VARCHAR(50) NULL DEFAULT NULL)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;
